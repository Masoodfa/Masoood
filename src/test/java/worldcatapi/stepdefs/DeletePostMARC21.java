...
public class DeletePostMARC21 extends BaseClass{
	...
	public void I_hit_post_delete_end_point_url() {
		...
		_RESP = _REQUEST_SPEC.headers(headers) 
				...
				.log().all().body(delMarc21).when().post("/worldcat/manage/holdings-unset");
