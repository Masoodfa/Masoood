...
public class DeletePostMARC21XML extends BaseClass{
	
	
String delMarc21XML = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><marc:collection xmlns:marc=\"http://www.loc.gov/MARC21/slim\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.loc.gov/MARC21/slim http://www.loc.gov/standards/marcxml/schema/MARC21slim.xsd\">\r\n"
	...
	public void The_post_delete_XML_API_is_up_and_running() {
	...
	public void I_hit_post_delete_XML_end_point_url() {

		//Headers
		Map<String,String> headers = new HashMap<String,String>();
		headers.put("Institution-Code", "78715");
		headers.put("Institution-Symbol", "WMAPI");
		headers.put("Content-Type", "application/marcxml+xml");
		...
		_RESP = _REQUEST_SPEC.headers(headers) 
				...
				.log().all().body(delMarc21XML).when().post("/worldcat/manage/holdings-unset");			
